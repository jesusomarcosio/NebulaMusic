...
public class Usuario {
    ...
    public Usuario(String nombre, String correo, String contrasenia, String txt_pseudonimo, String rad_genero, String sel_subscripcion, String fechaNacimiento, String chk_terminos, String comentarios) {
        this.nombre = nombre;
        this.correo = correo;
